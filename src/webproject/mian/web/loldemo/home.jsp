...
<div style="width:1518px;height: 950px;min-width:100%">
    ...
    <div id="stu" style="/*margin-top:80px;*/display:inline-block;" >
        ...
        <a  href="http://localhost:6060/League_of_Legends_war_exploded/loldemo/index.jsp?shopdemo="><img src="\subject\sy1.jpg"  alt="" width="1518px" height="502px" class="imgs" name="0" style="display: block"></a>
        <a  href="http://localhost:6060/League_of_Legends_war_exploded/loldemo/home.jsp"><img src="\subject\sy2.jpg" alt="" width="1518px" height="502px" class="imgs" name="1" style="display: none"></a>
        <a  href="http://localhost:6060/League_of_Legends_war_exploded/loldemo/demo1.jsp"><img src="\subject\sy3.jpg" alt="" width="1518px" height="502px" class="imgs" name="2" style="display: none"></a>

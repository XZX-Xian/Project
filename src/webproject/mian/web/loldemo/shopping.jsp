...
<c:forEach items="${list}" var="lit">
    <tr class="collect">
        ...
        <td><img src="\subject\tb-.jpg" alt="minus"  style="width: 15px;height: 15px" class="minus">
            <input class="num" type="text" value="${lit.comSize}" readonly="readonly" size="1">
            <img src="\subject\tb+.jpg" alt="add" style="width: 15px;height: 15px;" class="adding"/>
        ...
        <div class="ycgwc" hidden style="width: 1191px;height: 300px">
            <div align="center" style="line-height: 300px">购物车内没商品,<a href="http://localhost:6060/League_of_Legends_war_exploded/loldemo/index.jsp?shopdemo=">去采购</a></div>
        </div>
    ...
    function deleteUsers(){
        ...
        if(ids.length>0){
            if(confirm("确定要删除选中的用户吗")){
                //确定要删除
                location.href="http://localhost:6060/League_of_Legends_war_exploded/dlusesp?shopid="+ids+"&useid="+userid+"";
            }
        }else{
            $(".c2cyh").show();
...
//订单采购
    function ddcg(){
        ...
        if(ids.length>0){
            location.href="http://localhost:6060/League_of_Legends_war_exploded/ddcgsele?shopid="+ids+"&useid="+userid+"";
        }else{
            $(".c2cyh").show();
        ...
        $(".minus").on("click",function () {
            ...
            if (count < 1) {
                ...
                location.href="http://localhost:6060/League_of_Legends_war_exploded/shopud?userid="+userid+"&shopid="+id+"&sum="+sums+"";
                moyesum();
            }

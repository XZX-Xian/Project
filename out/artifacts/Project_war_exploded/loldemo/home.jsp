...
<table border="1px" align="center">
    <div class="c2" hidden style="z-index: 101">
        <div align="center">
            ...
            <form action="http://localhost:8080/Project_war_exploded/seluer">
            ...
            <div style="height:55px;background-color: white">
                ...
                <div style="position: absolute;right: 1px;top: 1px">
                    ...
                    <div class="gouwuc" style="width: 120px;height: 55px;display:inline-block;margin-right: 10px">
                        <img src="\subject\gwc.png" alt="购物车" width="35px"
                             style="position: absolute;top: 12px;margin-left: 0px;margin-top: 3px">
                        <strong style="position: absolute;top: 12px;margin-left: 32px;margin-top: 10px;width: 90px"><a>购物车</a></strong>
                    </div>
                </div>
                <%--导航栏内容--%>

    ...
    $(function () {
        ...
        $(".gwc").click(function () {
            if (account != "" && account != null && account != "null") {
                ...
                location.href = "http://localhost:8080/Project_war_exploded/inseshop?id=" + id + "&name=" + name + "&money=" + money + "&size=" + size + "&ove=" + ove + "&userid=" + userid + "&inventory="+inventory+"&volume="+volume;
            } else {
                $(".c2cyh").show();
...
<form>
    <table border="1px" align="center">
        ...
        <div align="center">
            <%--头部--%>
            <div align="center"
                 style="width: 1080px;height: 50px;background-color: #ffffff;/*position: fixed;z-index: 999;*/">
                <%--logo--%>
                ...
                <div a style="height:55px;background-color: white;margin-bottom: 30px;">
                    ...
                    <%--登录框--%>
                    <div class="dltis"
                         style="width: 160px;height: 47px;display:inline-block;position: absolute;right: 210px;">
                        <div style="position: absolute;top: 12px;margin-top: 5px"><img src="\subject\yhu.png" alt=""
                                                                                       class="dlus" width="40"></div>
                        <div class="grdiv" style="margin-left: 50px;border-top: 1px #ffffff solid">
                            <p hidden class="hyp" style="position: absolute;top: 12px;margin-top: 17px;"><strong
                                    style="font-size: 13px;">(<label class="userid"></label>)</strong></p>
                            <ul style=" padding:0; margin:0;list-style-type: none;margin-top: 50px;margin-right: 17px"
                                hidden class="grzx">
                                <li id="user">个人中心</li>
                    ...
                    <%--购物车框--%>
                    <div class="gouwuc"
                         style="height: 55px;display:inline-block;margin-left: 15px;position: absolute;right: 255px;top: 25px;">
            ...
            <div style="width: 1082px;height: 36px;margin-top: 35px;">
                <div align="left" style="width: 1082px;height: 36px;background-color: #0abb26;">
                    <ul class="sm">
                        <li><strong><a
                                href="http://localhost:8080/Project_war_exploded/loldemo/home.jsp">商城首页</a></strong><img
            ...
            <div style="width: 1080px;height: 680px;margin-top: 0;border: 1px #ccc solid">
                <div style="width: 500px;height: 500px;float: left;display: block;margin-left: 40px;margin-top: 25px;">
                    <div style="display: block;margin-right: 20px;margin-top: 40px">
                        <img style="width: 300px;height: 340px" class="perso" src="<%=request.getAttribute("listove")%>"
                             alt="">
                    </div>
                    <div class="ove"
                         style="display: inline-block;border: 1px #ccc solid;width: 50px;height: 50px;margin-top: 50px;margin-right: 30px">
                        <img style="width: 50px;height: 50px" src="<%=request.getAttribute("listove")%>" alt="">
                    </div>

                    <div class="out"
                         style="display: inline-block;border: 1px #ccc solid;width: 50px;height: 50px;margin-top: 50px">
                ...
                <div style="display: inline-block;width: 460px;margin-top: 25px">
                    ...
                    <div align="right" style="align-items: center">
                        ...
                        <ul class="shangp">
                            <li>
                                <h4 align="left">商品类型:<%=request.getAttribute("listproduct")%>
                                </h4>
                                <span style="font-size: 12px;color: #ccc">项目编号：<label class="bh"
                                                                                      style="font-size: 12px;color: #ccc"><%=request.getAttribute("listcomId")%></label></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div align="left">
                        <ul class="shangp">
                            ...
                            <li>
                                <p style="font-size: 24px" class="nam"><%=request.getAttribute("listname")%>
                                </p>
                                <p style="display: inline;font-size: 25px;font-weight: bold"
                                   class="mone"><%=request.getAttribute("listmoney")%>
                                </p><label style="font-size: 13px">RMB</label>
                        ...
                        <div style="position: absolute;top:247px;right: 280px;">
                            <text class="shouc"
                                  style="display: block;border: 1px #ccc solid;text-align: center;width: 45px;height: 45px;line-height: 45px;background-color: white;font-size: 12px">
                                收藏
                            </text>

                            <text disabled
                                  style="display: block;margin-top: 13px;text-align: center;border: 1px #ccc solid;width: 43px;height: 40px;background-color: white;font-size: 9px;padding-top: 5px">
                                交易量<p style="margin-top: 5px;font-size: 12px" id="volume"><%=request.getAttribute("listcount")%>
                            </p></text>
                        </div>
                    </div>
                    ...
                    <div align="left">
                        <ul class="shangp">
                            <li>
                                <p style="font-size: 13px">颜色：<%=request.getAttribute("listcolor")%>
                                </p>
                                <p style="font-size: 13px">尺码：<%=request.getAttribute("listmodell")%>
                                </p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div align="left">
                        <ul class="shangp">
                            <li>
                                <p style="font-size: 13px">库存:<span id="inventory"><%=request.getAttribute("listquantity")%></span>
                                </p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div align="right">
                        <div align="left">
                            <ul style="list-style-type: none">
                                <li>
                                    ...
                                    <input type="button" class="fu"
                                           style="height: 25px;border: 1px #999999 solid;width: 26px;text-align: center;"
                                           value="-">
                                    <input type="text" disabled name="size"
                                           style="background-color: white;width: 43px;text-align: center;border: 1px solid #999999;border-left: none; border-right: none;height: 25px;margin-left: -5px"
                                           value="1">
                                    <input type="button"
                                           style="height: 25px;border: 1px #999999 solid;width: 25px;text-align: center;margin-left: -5px"
                                           class="jia" value="+">
                        ...
                        <ul class="shangp" style="margin-top: -15px">
                            <li>
                                <p style="font-size: 18px">总额:<span
                                        id="sum"><%=request.getAttribute("listmoney")%></span><label
                                        style="font-size: 13px">:00RMB</label></p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="gwc" align="center"
                             style="margin-top: 10px;display: inline-block;margin-left: 30px">
                            <input type="button" value="加入购物车"
                                   style="border:1px #ccc solid;font-size: 15px;font-weight: bold;color: black;margin-right:5px;background-color: #ffffff;border-radius: 5px;width: 203px;height: 50px;">
                        </div>
<%--                        <div align="center" style="margin-top: 10px;display: inline-block">--%>
<%--                            <input type="button" value="采购"--%>
<%--                                   style="border:none;font-size: 15px;font-weight: bold;color: #ffffff;background-color: #2e8de5;border-radius: 5px;width: 203px;height: 50px;">--%>
<%--                        </div>--%>
            ...
            <div style="margin-top: 25px;width: 1080px;background-color: rgba(223, 230, 233,0.4)">
                <div align="left"
                     style="margin-top: 15px;width: 1076px;border: 2px #ccc solid;background-color: #ffffff">
                    <div style="margin-left: 45px;">

                        <p align="center" style="margin-left: -75px">商品详情资料</p>
                        <p style="display: inline-block;margin-top: -5px">品牌名称：<%=request.getAttribute("listbrand")%>
                        </p>
                        <p style="display: block">产品参数:<%=request.getAttribute("listmodell")%>
                        </p>
                        <p style="display: inline-block;margin-right: 120px">型号:<%=request.getAttribute("listmodell")%>
                        </p>
                        <p style="display: inline-block;margin-right: 120px">
                            积累评价：<%=request.getAttribute("listappcount")%>
                        </p>
                        <p style="display: inline-block;margin-right: 120px;margin-bottom: 20px">
                            出售状态:<%=request.getAttribute("liststate")%>
                        </p>
                    </div>
                </div>

                <div class="cctv" style="height: 780px;overflow: hidden">
                    <img align="center" src="<%=request.getAttribute("listcctv")%>" alt="商品详情"
                         style="width: 850px;margin-top: 35px">
                </div>
                <div class="zkai"
                     style="border-radius: 5px;line-height: 50px;border: 1px #cccccc solid;background-color: #ffffff;width: 250px;height: 50px;color: black;font-weight: bold">
                    展开全部
                </div>
                <div class="sohui"
                     style="border-radius: 5px;line-height: 50px;border: 1px #cccccc solid;background-color: #ffffff;width: 250px;height: 50px;color: black;font-weight: bold"
            ...
            <div align="center"
                 style="width: 1090px;height: 80px;display: inline-block;margin-left: -240px;margin-top: 10px">

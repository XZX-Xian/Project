        ...
        $(function () {
            ...
            $(".userupda").click(function () {
                ...
                if(Upname==""||Updh==""||Uppwd==""){
                    ...
                    /*location.href="http://localhost:6060/League_of_Legends_war_exploded/upuser?Uppwd="+Uppwd+"&Upname="+Upname+"&Updh="+Upname;*/
            ...
            $(".userdhdl").click(function () {
                ...
                var userpwd=$("input[name=userpwd ]").val();
                location.href="http://localhost:6060/League_of_Legends_war_exploded/seluerdh?userdh="+userdh+"&userpwd="+userpwd+"";
...
<form action="http://localhost:6060/League_of_Legends_war_exploded/seluerUp">
    <table  <%--border="1px"--%>>
        ...
        <tr>
            ...
            <%--     &lt;%&ndash;       &lt;%&ndash;登录&ndash;%&gt;
                        <div class="yhdl" align="left" style="margin-top: 18px;margin-left: 5px;">
                    ...
                    &lt;%&ndash;电话登录&ndash;%&gt;
                      <div class="dh" style="margin-left: 30px;margin-top: 35px;" hidden>
                            ...
                            <div style="margin-right: 30px;margin-top: -15px" align="right">
                               <a class="wjmms" style="font-size: 12px">忘记密码？</a>
                            </div>
                            ...
                            <div align="center" style="margin-top: 40px">
                                <input type="button" hidden class="userdhdl" value="电话登录" style="border:none;font-size: 15px;font-weight: bold;color: white;background-color: black;border-radius: 5px;width: 295px;height: 50px;">
                            </div>

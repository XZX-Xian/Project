...
<div style="width:1518px;min-width:100%">
    ...
    <div style="width: 1518px;height: 36px;background-color: #1e272e;">
        <ul class="sm">
            ...
            <li><a href="http://localhost:6060/League_of_Legends_war_exploded/loldemo/index.jsp?shopdemo=">商品区</a><img
            ...
            <div style="display: inline-block;width: 300px;background-color: white;">
                ...
                <ul id="bt">
                    <li><a style="font-size: 12px"
                           href="http://localhost:6060/League_of_Legends_war_exploded/selehome?name=14">[英雄联盟]龙年限定迷你套装
                        <img src="\commodity\longnian.png" height="80px" width="178px"></a>
                    </li>
                    <li><a style="font-size: 12px"
                           href="http://localhost:6060/League_of_Legends_war_exploded/selehome?name=15">[英雄联盟]复活节限定迷你套装
